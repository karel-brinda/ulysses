...
public:
    ...
    int query(const uchar *gstr, int dir, unsigned int bytes_compr_kmer) const;
...
std::map<std::string,Bloom>* bloom_create_many_blooms(const Bloom * initial_bf, const Bloom * exclude_bf,const Bloom * include_bf, const coor as_b, const unsigned int nh, const char *seedstr, const char *fn, int both_directions, const size_t max_threads, const size_t work_unit_size = 100000);
